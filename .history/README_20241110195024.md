...
- Hackathon Showcase: Create sections to display both pre and upcoming hackathons, helping users explore event details and get excited about future events.
